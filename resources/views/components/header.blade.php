                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            ...
                            <span
                                class="badge light text-white bg-warning rounded-circle">{{ auth()->user()->unreadNotifications()->count() }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50"
                                                            src="{{ asset('uploads/profil/' . $notification->data['photo']) }}">
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="mb-1">{{ $notification->data['messages'] }}</h6>
                                                        <small
                            ...
                            <a class="all-notification" href="javascript:void(0);">Tutup <i
                                    class="ti-arrow-end"></i></a>
                        </div>
                    </li>
                    <li class="nav-item dropdown  header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="{{ asset('uploads/profil/' . Auth::user()->photo) }}" width="56"
                                alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
