<table class="table table-responsive-md">
    <thead>
        <tr>
            ...
            <th><strong>Nama Ruang</strong></th>
    ...
    <tbody>
        @if (count($data) > 0)
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <button type="button" onclick="edit({{ $d->id }})" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt" data-bs-toggle="modal" data-bs-target="#ruanganModal"></i></button>
