                    ...
                    <div class="profile-head">
                        ...
                        <div class="profile-info">
                            <div class="profile-photo">
                                <img src="{{ asset('uploads/profil/' . Auth::user()->photo) }}"
                            ...
                            <div class="profile-details">
                                ...
                                <div class="dropdown ms-auto">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li class="dropdown-item"><i class="fa fa-user-circle text-primary me-2"></i> Lihat
                                            Akun</li>
                            ...
                            <div class="card-body">
                                <div class="profile-statistics">
                                    <div class="text-center">
                                        <div class="row">
                                            <div class="col">
                                                <h3 class="m-b-0">150</h3><span>Tidak Diterima</span>
                                            </div>
                                            <div class="col">
                                                <h3 class="m-b-0">140</h3><span>Pending</span>
                                            </div>
                                            <div class="col">
                                                <h3 class="m-b-0">45</h3><span>Diterima</span>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <a href="javascript:void(0);" class="btn btn-primary mb-1 me-1">Lihat detail
                                                dokumen</a>
